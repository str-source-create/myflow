 ...
 *
 * This is the official CleanFlow cleaning checklist.
 * Based on the production cleaning guide used by the team.
 * All items and areas match the printed PDF checklist exactly.
 *
 * Admins can add/remove/rename areas and items when creating a task.
 * Workers see these same items on their checklist during cleaning.
 */
...
export default function CreateTaskPage() {
  ...
  const deleteArea = (areaId) => {
    if (!confirm('Delete this entire area and all its items?')) return
